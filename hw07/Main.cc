...
int main(){
    ...
    const int INIT_SWIM_SP_MIN = 4;
    const int INIT_SWIM_SP_MAX = 5;
    const int INIT_TURN_SP_MIN = 45;
    const int INIT_TURN_SP_MAX = 90;
    ...
    while(fishList.getPopCount() < fishList.getMaxFishes()){
        ...
        //
        new Fish(INIT_X, INIT_Y, rRange(INIT_SWIM_SP_MIN, INIT_SWIM_SP_MAX), rRange(INIT_TURN_SP_MIN,INIT_TURN_SP_MAX), INIT_DIR, flRef);
